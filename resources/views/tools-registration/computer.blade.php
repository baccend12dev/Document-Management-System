           ...
           <!-- Header -->
            <div class="card shadow-lg" style="border-radius: 0.5rem; border-left: 4px solid #4f46e5;">
                <div class="card-body p-4">
                    ...
                    <form method="GET" action="{{ route('tools.show', 'computer') }}">
                        <div class="row">
                            <!-- Search -->
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="d-flex">
                                    ...
                                    <a href="{{ route('tools.show', 'computer') }}" class="btn btn-secondary btn-sm">
            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 font-weight-bold">Computerize System Validation List</h5>
            ...
            <div class="form-section" id="addEquipmentForm">
                <h3 class="mb-4 font-weight-bold">Add New Computerize System Validation</h3>
                 <form action="{{ route('tools.store.equipment') }}" method="POST">
                    {{ csrf_field() }}
                    <!-- hiide input sub menu -->
                    <input type="hidden" name="sub_menu" value="computer">

                    <div class="row">
                         <div class="col-md-6">
                            <div class="form-group">
                                <label class="font-weight-semibold">System Name <span
