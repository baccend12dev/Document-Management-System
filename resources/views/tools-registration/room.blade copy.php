    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="form-section">
                <h3 class="mb-4 font-weight-bold">Add New Room Qualification</h3>

                <form action="{{ route('tools.store.equipment') }}" method="POST">
                    {{ csrf_field() }}
                    <!-- hiide input sub menu -->
                    <input type="hidden" name="sub_menu" value="room">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="font-weight-semibold">AHU</label>
                                <select class="form-control" name="AHU" id="ahuCode">
                                    <option value="">Select AHU Code</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="model" id="brand"
...
$('#serviceArea').on('change', function() {
    ...
    $('#roomName').html('<option>Loading...</option>');
    $('#roomNumber').html('<option>Loading...</option>');
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#roomName').html('<option value="">Select Room Name</option>');
